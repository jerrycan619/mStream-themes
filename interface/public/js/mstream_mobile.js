...
var spinner1_html = '<div class="d-flex justify-content-center">' +
  ...
  $(document).ready(function () {
    ...
    function printdir(response, previousState) {
      ...
      $.each(currentBrowsingList, function () {
        ...
        if (this.type == 'directory') {
          filelist.push(`<div class="row m-2 align-items-center">
      ...
      $.each(currentBrowsingList, function () {
        ...
        if (lowerCase.indexOf(searchVal.toLowerCase()) !== -1) {
          ...
          if (this.type === 'directory') {
            ...
            filelist.push(`<div data-directory="${this.name}" class="dirz row m-2 align-items-center">
                                  <div class="col">
                                    <div class="row align-items-center">
                                      ...
                                      <div class="col pl-0 d-flex flex-column">
                                        <span class="col_track_title">${this.name}</span>
    ...
    $('#get_library').on('click', function () {
        ...
        $('#fillContent').html('<div id="library_tabs">' +
            '<div class="slides_lib_nav">' +
                '<div>Albums</div>' +
                '<div>Artists</div>' +
                '<div>Playlists</div>' +
                '<div>Rated</div>' +
            '</div>' +
            '<!-- <div>' +
              '<span id="lib_nav_albums">Albums</span>' +
              '<span id="lib_nav_artists">Artists</span>' +
              '<span id="lib_nav_playlists">Playlists</span>' +
              '<span id="lib_nav_rated">Rated</span>' +
            '</div> -->' +
            '<div class="slides_lib">' +
                '<div id="getAlbums">' +
    ...
    $('#get_system').on('click', function () {
      ...
      $('#fillContent').html('<div id="system_tabs row flex-column m-0">' +
          '<div class="col-auto p-0 slides_system_nav">' +
              '<div>Settings</div>' +
              '<div>Federation</div>' +
              '<div>Transcode</div>' +
          '</div>' +
          '<div data-simplebar class="slides_system col p-0">' +
              '<div id="getSettings"></div>' +
              '<div id="getFederation"></div>' +
              '<div id="getTranscode"></div>' +
          '</div>' +
      '</div>');
                      ...
                      <div class="row mt-4">\
                        <div class="col">\
                          <div class="row m-0 align-items-center justify-content-between">\
                              ...
                              <div class="col-auto">\
                                <input type="button" value="Build" id="build_database">\
                              </div>\
                          </div>\
                        </div>\
                      </div>\
                      <div class="row mt-4">\
                        <div class="col">\
                          <div class="row m-0 align-items-center justify-content-between">\
                              ...
                              <div class="col-auto">\
                                <button id="logout">
                                  <span class="mdi-set mdi-logout navbar_icon mr-3">Logout</span>\
                                </button>
                              </div>\
                          </div>\
                        </div>\
    ...
    function createJukeboxPanel() {
      ...
      if (JUKEBOX.stats.adminCode) {
        jukeBox_html_inner = `<div class="col">Code: ${JUKEBOX.stats.adminCode}</div>`;
      }
